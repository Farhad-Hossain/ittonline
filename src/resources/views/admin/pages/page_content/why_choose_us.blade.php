                ...
                <form action="{{route('admin.page_content.why_choose_us')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="content_best_it_training_industry" class="form-control" value="{{$content ? $content->content_best_it_training_industry : ''}}" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="" class="form-label">Content of (Professional Trainers)</label>
                            <input type="text" name="content_professional_trainers" class="form-control" value="{{$content ? $content->content_professional_trainers : ''}}" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="" class="form-label">Content of (Award Winning)</label>
                            <input type="text" name="content_award_winning" class="form-control" value="{{$content ? $content->content_award_winning : ''}}" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="" class="form-label">Content of (24/7 Support)</label>
                            <input type="text" name="content_support" class="form-control" value="{{$content ? $content->content_support : ''}}" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="" class="form-label">Middle Photo (.jpg, .jpeg, .png, .bmp)</label>
                            <input type="file" name="middle_photo" class="form-control" value="{{$content ? $content->middle_photo : ''}}" 
                                {{$content ? '' : 'required'}}
                            >
                        </div>
