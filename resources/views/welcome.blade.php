...
<body style="background-color: #e6e6e6">
	<div class="u-content-container u-top-navigation-container d-flex justify-content-between">
		<div>
	...
	<div class="u-content-container">
		<div style="background-color: white; padding: 45px;">
			<div style="background-color: rgb(100, 100, 100); border-radius: 3px; min-height: 200px;" class="mt-4 p-2">
				<h1>Corvit is now the PearsonVUE authorised test center. Schedule your exam at Pearsonvue.com</h1>
			</div>
		</div>
	</div>
</body>
